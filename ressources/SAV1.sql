...
--
-- Client: localhost
-- Généré le: Dim 10 Janvier 2016 à 03:36
...
--
CREATE DATABASE `fullluck_ok6x` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fullluck_ok6x`;
